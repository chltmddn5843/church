...
export default async function AdminLivePage() {
  ...
  return (
    <>
      <h1 className="text-3xl font-bold">생방송 관리</h1>
      <p className="mt-2 text-muted-foreground">YouTube 생방송 또는 예약 영상 URL을 저장하면 메인 페이지에 표시됩니다.</p>
      ...
      {current && (
        <>
          ...
          <form action={clearLiveStream} className="mt-4">
            <Button type="submit" variant="destructive">메인 페이지에서 생방송 섹션 끄기</Button>
          </form>
        </>
      )}
    </>
