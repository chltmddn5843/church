...
export async function FeaturedSermons() {
  ...
  return (
    <div>
      <SectionHeading eyebrow="Message" title="최근 말씀" />
      {latest ? (
        <div className="mt-8 overflow-hidden rounded-2xl border border-border bg-card shadow-xl shadow-primary/10">
        ...
        <div className="mt-8"><SermonCard sermon={sermons[0]} /></div>
      ) : (
        <p className="mt-8 text-center text-muted-foreground">최근 말씀을 불러오지 못했습니다.</p>
      )}
