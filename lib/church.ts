...
export const church = {
  ...
  nav: [
    ...
    },
    {
      ...
      children: [
        { title: "아기학교·유아·유치부", href: "/next-generation#kids" },
        { title: "유년·초등부", href: "/next-generation#children" },
        { title: "중등·고등부", href: "/next-generation#youth" },
        { title: "청년부", href: "/next-generation#young-adult" },
        { title: "영어예배·AWANA", href: "/next-generation#kids" },
      ],
    },
    {
      title: "커뮤니티",
